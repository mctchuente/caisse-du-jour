@extends('layouts.app')
@section('title', __('Ajouter Entrée de fond de caisse'))
@section('content')
@push('style')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
				...
				<form method="POST" action="{{ route('encaissement.store') }}" enctype="multipart/form-data">
                    @csrf
					
					<div class="card-header">{{ __('Nouvelle Entrée de fond de caisse') }}</div>
					...
					<div class="card-body p-1">
						...
						<div class="col-md-12 p-2 bg-white">
									...
									<div class="row">
										...
										<div class="col-md-12">
											<select id="type-operation" name="type_operation" class="form-select @error('type_operation') is-invalid @enderror">
												...
												@if (old('type_operation')=='dépôt de caisse')
												...
												@endif
												@if (old('type_operation')=='remise en banque')
									...
									<div class="row">
										...
										<div class="col-md-12">
											<div class="flatpickr input-group">
												<input type="text" class="form-control form-control2 @error('date_saisie') is-invalid @enderror" name="date_saisie" value="{{ old('date_saisie') }}" required id="date-saisie" aria-describedby="date_saisie_help" data-input />
							...
							<div class="row mb-2 mx-4">
								...
								<div class="col-md-12">
									<textarea id="commentaire" class="form-control @error('commentaire') is-invalid @enderror" name="commentaire">{{ old('commentaire') }}</textarea>
